...
class TorchModel(nn.Module):
    def __init__(self, config):
        ...
        self.classifier1 = nn.Linear(self.bert.config.hidden_size, config["num_labels"])
        self.classifier2 = nn.Linear(self.bert.config.hidden_size, config["num_labels"])
        self.classifier3 = nn.Linear(self.bert.config.hidden_size, config["num_labels"])
        self.classifier4 = nn.Linear(self.bert.config.hidden_size, config["num_labels"])
